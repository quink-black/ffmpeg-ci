# Using local ffmpeg source from ~/work/ffmpeg
# Detect ffmpeg source path dynamically
# Get directory containing this portfile and navigate to ffmpeg source
...
if("bzip2" IN_LIST FEATURES)
    # Auto-detect bzlib, do not force enable
...
if("opencv" IN_LIST FEATURES)
    ...
    # Per-configuration CXX runtime flags for OpenCV/C++ code
    set(OPENCV_CXXFLAGS_RELEASE "-MD" "-D_DLL" "-D_MT")
    set(OPENCV_CXXFLAGS_DEBUG "-MDd" "-D_DLL" "-D_MT" "-D_DEBUG")
else()
...
# Force static linking for ffmpeg internal libraries (libavcodec, libavformat, etc.)
# This makes ffmpeg.exe and ffplay.exe statically link libav* libraries
# External dependencies (like libx264, libvpx) are still linked based on VCPKG_LIBRARY_LINKAGE
